...
public class Sayfa_121_KeyboardActions extends TestBase {
...
8- “Double click me" butonunu cift tiklayin
    ...
    public void test01() {
        ...
        WebElement meFirstButton= driver.findElement(By.xpath("//button[.='Hover Over Me First!']"));
        actions.moveToElement(meFirstButton).build().perform();

        //    3. "Link 1" e tiklayin
        driver.findElement(By.xpath("(//a[.='Link 1'])[1]"));
        ...
        actions.clickAndHold(clickAndHoldBas);
        ...
        actions.doubleClick(doubleClickYap);
