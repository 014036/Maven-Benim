...
//"online banking' bolumune gidiniz
        ...
        //7. amount kismina yatirmak istediginiz herhangi bir miktari yazin
        driver.findElement(By.id("sp_amount")).sendKeys("400");
        ...
        Assert.assertEquals("The payment was successfully submitted.", sonucYazisi.getText());
