...
public class TrendyolKendimYazdim {
  ...
  2.  "Sepete En Cok EKlenenler" basligina tiklayin
    3.Acilan sayfada sepete en cok eklenen ilk 4 urun icin
     ...
     6.Her bir urunden sonra "Ürün Değerlendirmeleri" basligina gidin
     ...
     10.Her bir urunun ayri ayri sepette gorundugunu toplu bir sekilde  Assert.assertTrue ile  dogrulayin
...
ipuculari:
1)  Tendyol sayfasin ilk acildiginda gelen uyarilari kapatmak icin:
        ...
        Thread.sleep(4000);
       kodlarini kullanin
  2) Yeni acilan sekmeye gecmek icin
          ArrayList<String> tabs2 = new ArrayList<String> (driver.getWindowHandles());
            driver.switchTo().window(tabs2.get(1));

           Sonra tekrar anasayfaya gecmek icin
              driver.close();
