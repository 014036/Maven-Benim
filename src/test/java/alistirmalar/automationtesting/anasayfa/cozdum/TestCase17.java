...
TEST VAKA 17
  17. Ev-Gelenler-Sepete Ekle-Ürünler-Ödeme-Ödeme Ağ Geçidi
1) Tarayıcıyı açın
...
18)Kullanıcı, ödeme ağ geçidi sayfasında kupon ekleme olanağına sahiptir ve ayrıca fatura, sipariş ve ek ayrıntıları bulabilir.
...
//11) Kullanıcı o Kitabı Menü öğesinde fiyatla görüntüleyebilir.
        ...
        System.out.println("fiyatGorunurMu.getText() = " + fiyatGorunurMu.getText());
        ...
        driver.findElement(By.xpath("//input[@id='payment_method_cod']")).sendKeys(Keys.SPACE);//teslimatta odeme secenegi

        //18)User has the feasibility to add coupon in the payment gateway page and also he can find billing,order and
        // additional details.
        //18)Kullanıcı, ödeme ağ geçidi sayfasında kupon ekleme olanağına sahiptir ve ayrıca fatura, sipariş ve ek
        // ayrıntıları bulabilir.
        WebElement kuponEklemeOlanagiVarMi= driver.findElement(By.xpath("//a[@class='showcoupon']"));
        Assert.assertTrue(kuponEklemeOlanagiVarMi.isEnabled());
