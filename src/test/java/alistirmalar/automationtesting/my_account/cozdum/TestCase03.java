...
11) Kullanıcı, Görünüm düğmesine tıklayarak Sipariş detaylarını, müşteri detaylarını ve fatura detaylarını görmelidir.
    ...
    //5) Enter password in password textbox //5) Şifre metin kutusuna şifreyi girin
        ...
        // 11) Kullanıcı, Görünüm düğmesine tıklayarak Sipariş detaylarını, müşteri detaylarını ve fatura detaylarını görmelidir.
        WebElement siparislerDetaylariGorunurMu = driver.findElement(By.xpath("//div[@class='woocommerce-MyAccount-content']"));
        Assert.assertTrue(siparislerDetaylariGorunurMu.isDisplayed());
    }
}
